                  ...
                  children: const [
                    Text("기록 지표 설명",
                        style: TextStyle(
                            ...
                            color: Colors.indigo)),
                    SizedBox(height: 8),
                    Text("• Valence: 감정의 긍정/부정 정도 (-5~5, -5:부정, 5:긍정)", style: TextStyle(fontWeight: FontWeight.bold)),
                    ...
                    Text("• Physical: 행동의 동적/정적 정도 (-5~5, -5:정적, 5:동적)", style: TextStyle(fontWeight: FontWeight.bold)),
